...
interface InputPanelProps {
  ...
  onInputChange: <K extends keyof RealEstateInputs>(key: K, value: number) => void;
...
export function InputPanel({
  ...
  const HelpButton = ({ configKey }: { configKey: keyof RealEstateInputs }) => (
    <Button
      variant="ghost"
      size="icon"
    ...
    return (
      <div className="bg-gradient-to-br from-white/70 to-zinc-50/70 dark:from-zinc-800/70 dark:to-zinc-900/50 backdrop-blur-md p-4 rounded-xl border border-white/50 dark:border-zinc-700/30 shadow-md">
        <div className="flex items-center">
          <Label className="text-gray-700 dark:text-gray-300">{config.label}</Label>
