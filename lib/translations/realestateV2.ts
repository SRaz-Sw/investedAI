...
export const realEstateV2Translations: Record<Language, RealEstateV2Translation> = {
  en: {
    // Page titles
    title: "Real Estate Investment Calculator",
    subtitle: "Discover the 3 engines of profit: Cash Flow, Appreciation & Equity Building",
    ...
    // Help text
    purchasePrice_help: "The price you're paying to buy the property",
    belowMarket_help: "If the property is worth $100K but you're buying for $70K, that's 30% below market",
    monthlyRent_help: "Expected monthly rental income from tenants",
    appreciation_help: "Historical average in Indianapolis is ~4% per year",
    rentGrowth_help: "Rent typically increases 3% annually with inflation",
    downPayment_help: "Your initial cash investment. 25% = 75% leverage",
    vacancyRate_help: "Percentage of time the property sits empty between tenants",
    insuranceTax_help: "Monthly cost for property insurance and property taxes",
    propertyManagement_help: "Fee charged by property management company (% of rent)",
    maintenance_help: "Annual maintenance costs as % of property value",
  ...
  he: {
    ...
    subtitle: "גלה את 3 מנועי הרווח: תזרים מזומנים, עליית ערך ובניית הון",
    
    // Input labels - Basic
    purchasePrice: "מחיר קנייה",
    ...
    // Help text
    purchasePrice_help: "המחיר שאתה משלם לקניית הנכס",
    belowMarket_help: "אם הנכס שווה $100K אבל אתה קונה ב-$70K, זה 30% מתחת לשוק",
